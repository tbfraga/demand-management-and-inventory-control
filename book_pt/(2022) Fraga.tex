...
\newcolumntype{b}{>{\columncolor{purple}}l}
...
\cline {3-5}
& B & \cellcolor{green} &  \multicolumn{1}{|b|}{} & \cellcolor{yellow}  & & & \cellcolor{purple} & B \\
\cline {3-5}
& C & \multicolumn{1}{|b|}{} &  \cellcolor{yellow} & \cellcolor{yellow} & & & \cellcolor{yellow} & C\\ \cline {3-5}
\end{tabular}
...
Assim, itens com classificação, de acordo com primeiro e segundo critério, AA, AB ou BA, são classificados como itens do grupo A. Já os itens com classificação CA, BB, e AC são classificados como itens do grupo B. E os itens com classificação CB, BC e CC são classificados como itens do grupo C.
